...
nsys profile --cuda-memory-usage=true --trace='cuda,cublas,cudnn,cusolver,osrt,nvtx,cusparse' --stats='true' --sample=none --export=sqlite -f true -o profile.${SLURM_PROCID} ${cmd}
